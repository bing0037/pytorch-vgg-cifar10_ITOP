...
class Masking(object):
    ...
    def init(self, mode='ERK', density=0.05, erk_power_scale=1.0):
        ...
        if mode == 'GMP':
            ...
            for module in self.modules:
                for name, weight in module.named_parameters():  # module represents a complete model here. --libn
    ...
    def fired_masks_update(self):   # just to print the fired (explored so far) weights. --libn
